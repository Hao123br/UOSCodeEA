...
# qty_scen =[1,2,3,4,5,6,7] #add qty of scenarios 
...
# Create the boxplot 
bp = ax.boxplot(list([data_to_plot[0],data_to_plot[2],data_to_plot[4]]), positions = [0,2,4]  ,patch_artist = True, flierprops=green_diamond, notch=True)
...
scen_names_SP = [
                 'UOS 200 Users | 4 UAV-BS | Small Cells',
         
                 'UOS 200 Users | 8 UAV-BS | Small Cells',
                 
                 'UOS 200 Users | 15 UAV-BS | Small Cells',
                 
                 'Percept 200 Users | 4 UAV-BS | Small Cells',
                 
                 'Percept 200 Users | 8 UAV-BS | Small Cells',
            
                 'Percept 200 Users | 15 UAV-BS | Small Cells']  
...
#200 users
ax3.stackplot(range(0,33),data_to_plot2[1], data_to_plot[1], labels=['TBS','UAV-BS'],colors=Palette_Colors)
...
#100 users
ax4.stackplot(range(0,33),data_to_plot2[2], data_to_plot[2], labels=['TBS','UAV-BS'],colors=Palette_Colors)
ax4.set(xlabel='No. Simulations', ylabel='User Attended (%)')
ax4.legend(loc='lower right')
ax4.set_title(scen_names_SP[2], fontsize=10)
#200 users
ax5.stackplot(range(0,33),data_to_plot2[3], data_to_plot[3], labels=['TBS','UAV-BS'],colors=Palette_Colors)
