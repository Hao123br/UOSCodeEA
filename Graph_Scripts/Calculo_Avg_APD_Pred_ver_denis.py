...
#smallcells
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/LTE/4enB_200U/plot_APD_200_4_0') as MeanThroughput:

    data1 = np.array(list((int(Run),int(time), float(Throughput)) for Run, time, Throughput in csv.reader(MeanThroughput, delimiter= ' ')))
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_8UABS_200U/plot_APD_200_4_8') as MeanThroughputUABS:
...
#PERCEPT 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_8UABS_200U/plot_APD_200_4_8') as MeanThroughputUABS7:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_15UABS_200U/plot_APD_200_4_15') as MeanThroughputUABS8:
...
#PERCEPT 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_15UABS_200U/plot_APD_200_4_15') as MeanThroughputUABS9:
...
#UOS 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_4UABS_200U/plot_APD_200_4_4') as MeanThroughputUABS16:
...
#PERCEPT 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_4UABS_200U/plot_APD_200_4_4') as MeanThroughputUABS17:
...
#smallcell
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/LTE/4enB_100U/plot_APD_100_4_0') as MeanThroughput2:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_8UABS_100U/plot_APD_100_4_8') as MeanThroughputUABS2:
...
#PERCEPT 8UABS    
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_8UABS_100U/plot_APD_100_4_8') as MeanThroughputUABS5:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_15UABS_100U/plot_APD_100_4_15') as MeanThroughputUABS12:
...
#PERCEPT 15UABS    
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_15UABS_100U/plot_APD_100_4_15') as MeanThroughputUABS13:
...
#UOS 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_4UABS_100U/plot_APD_100_4_4') as MeanThroughputUABS20:
...
#PERCEPT 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_4UABS_100U/plot_APD_100_4_4') as MeanThroughputUABS21:
...
plt.savefig("Graph_Avg_APD_PERCEPT.pdf", format='pdf', dpi=1000, bbox_inches = "tight")
#plt.show()
...
fig2.savefig('APD_100U_S.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))

extent = ax5.get_tightbbox(fig2.canvas.renderer).transformed(fig2.dpi_scale_trans.inverted())
fig2.savefig('APD_200U_S.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))
