...
# ax2.set(xlabel='Number of UAV-BS', ylabel='Throughput (Mbps)')
...
# ax3.set(xlabel='Number of UAV-BS', ylabel='Throughput (Mbps)')
...
ax4.set(xlabel='Number of UAV-BS', ylabel='Throughput (Mbps)')
...
plt.savefig("Graph_Avg_Throughput_per_user_PERCEPT_300-400.pdf", format='pdf', dpi=1000, bbox_inches = "tight")
#plt.show()
...
# fig2.savefig('TP_100U_NS.pdf', bbox_inches=extent)#.expanded(1.15, 1.15))
...
# fig2.savefig('TP_200U_NS.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))

extent = ax4.get_tightbbox(fig2.canvas.renderer).transformed(fig2.dpi_scale_trans.inverted())
fig2.savefig('TP_300U_S.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))

extent = ax5.get_tightbbox(fig2.canvas.renderer).transformed(fig2.dpi_scale_trans.inverted())
fig2.savefig('TP_400U_S.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))
