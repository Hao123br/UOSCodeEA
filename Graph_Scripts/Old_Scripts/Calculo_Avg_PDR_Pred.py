...
#smallcells
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/LTE_and_UOS_Results/LTE/4enB_200U/plot_PDR_200_4_0') as MeanThroughput:

    data1 = np.array(list((int(Run),int(time), float(Throughput)) for Run, time, Throughput in csv.reader(MeanThroughput, delimiter= ' ')))
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/LTE_and_UOS_Results/UOS/4enB_8UABS_200U/plot_PDR_200_4_8') as MeanThroughputUABS:
...
#PERCEPT 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/Percept_Results/4enB_8UABS_200U/plot_PDR_200_4_8') as MeanThroughputUABS7:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/LTE_and_UOS_Results/UOS/4enB_15UABS_200U/plot_PDR_200_4_15') as MeanThroughputUABS8:
...
#PERCEPT 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/Percept_Results/4enB_15UABS_200U/plot_PDR_200_4_15') as MeanThroughputUABS9:
...
#no_smallcell
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/LTE_and_UOS_Results/LTE/4enB_200U/plot_PDR_200_4_0') as MeanThroughput1:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/LTE_and_UOS_Results/UOS/4enB_8UABS_200U/plot_PDR_200_4_8') as MeanThroughputUABS1:
...
#PERCEPT 8UABS 
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/Percept_Results/4enB_8UABS_200U/plot_PDR_200_4_8') as MeanThroughputUABS6:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/LTE_and_UOS_Results/UOS/4enB_15UABS_200U/plot_PDR_200_4_15') as MeanThroughputUABS10:
...
#PERCEPT 15UABS 
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/Percept_Results/4enB_15UABS_200U/plot_PDR_200_4_15') as MeanThroughputUABS11:
...
#smallcell
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/LTE_and_UOS_Results/LTE/4enB_100U/plot_PDR_100_4_0') as MeanThroughput2:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/LTE_and_UOS_Results/UOS/4enB_8UABS_100U/plot_PDR_100_4_8') as MeanThroughputUABS2:
...
#PERCEPT 8UABS    
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/Percept_Results/4enB_8UABS_100U/plot_PDR_100_4_8') as MeanThroughputUABS5:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/LTE_and_UOS_Results/UOS/4enB_15UABS_100U/plot_PDR_100_4_15') as MeanThroughputUABS12:
...
#PERCEPT 15UABS    
with open(path+'/home/emanuel/Desktop/IEEE_Article/Small_Cells/Percept_Results/4enB_15UABS_100U/plot_PDR_100_4_15') as MeanThroughputUABS13:
...
#no_smallcell
#LTE 
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/LTE_and_UOS_Results/LTE/4enB_200U/plot_PDR_200_4_0') as MeanThroughput3:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/LTE_and_UOS_Results/UOS/4enB_8UABS_100U/plot_PDR_100_4_8') as MeanThroughputUABS3:
...
#PERCEPT 8UABS      
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/Percept_Results/4enB_8UABS_100U/plot_PDR_100_4_8') as MeanThroughputUABS4:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/LTE_and_UOS_Results/UOS/4enB_15UABS_100U/plot_PDR_100_4_15') as MeanThroughputUABS14:
...
#PERCEPT 15UABS      
with open(path+'/home/emanuel/Desktop/IEEE_Article/No_Small_Cells/Percept_Results/4enB_15UABS_100U/plot_PDR_100_4_15') as MeanThroughputUABS15:
...
bars = ax2.bar(np.arange(10), means_2enb, yerr= yerr_2enb, error_kw=dict(lw=2, capsize=5, capthick=2),
               width = barwidth, color= uniquefuckingcolors, align="center",tick_label=scenarios)
...
ax2.set_ylim([0,100])
#plt.xticks([r+barwidth for r in range(len(scenarios))], scenarios)
