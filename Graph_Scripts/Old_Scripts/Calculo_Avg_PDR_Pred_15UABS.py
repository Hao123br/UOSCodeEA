    ...
    for i in range(NRuns):
        ...
        for j in range(len(Run)):
            if (Run[j]==i):
                ...
                if (time[j] == 100):
                    # print("RUN " + str(i))
                    # print("Tiempo: "+ str(time[j]))
                    # Throughputarr[i] = Throughput[int(max(Run))]
                    Throughputarr[i] = Throughput[j]
                    # print("PDR mean: " + str(Throughputarr[i]) + " de RUN " + str(i) )
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen1-PDR/plot_PDr_200U_4_enB_NoUABS') as MeanThroughput:

    data1 = np.array(list((int(Run),int(time), float(Throughput)) for Run, time, Throughput in csv.reader(MeanThroughput, delimiter= ' ')))

with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen1-PDR/plot_PDr_200U_4_enB_6UABS') as MeanThroughputUABS:
...
with open(path+'/home/emanuel/IEEE_Article/final_fix/4enB_15UABS_200U/1/plot_PDR_200_4_15') as MeanThroughputUABS7:
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen2-PDR/plot_PDr_200U_2_enB_NoUABS') as MeanThroughput1:
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen2-PDR/plot_PDr_200U_2_enB_6UABS') as MeanThroughputUABS1:
...
with open(path+'/home/emanuel/IEEE_Article/final_fix/2enB_15UABS_200U/1/plot_PDR_200_2_15') as MeanThroughputUABS6:
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen3-PDR/plot_PDr_100U_4_enB_NoUABS') as MeanThroughput2:
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen3-PDR/plot_PDr_100U_4_enB_6UABS') as MeanThroughputUABS2:
...
with open(path+'/home/emanuel/IEEE_Article/final_fix/4enB_15UABS_100U/1/plot_PDR_100_4_15') as MeanThroughputUABS5:
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen4-PDR/plot_PDr_100U_2_enB_NoUABS') as MeanThroughput3:
...
with open(path+'/home/emanuel/v2_master_thesis_UOS/Reports_and_Graphs/Scen4-PDR/plot_PDr_100U_2_enB_6UABS') as MeanThroughputUABS3:
...
with open(path+'/home/emanuel/IEEE_Article/final_fix/2enB_15UABS_100U/1/plot_PDR_100_2_15') as MeanThroughputUABS4:
...
# print("PDR 200 2enb ultima pos LTE:")
# print(Throughput2[NRuns_scen3])
# print("PDR 200 2enb ultima pos UOS:")
# print(Throughput3[NRuns_scen4])
# print("PDR 200 2enb ultima pos PERCEPT:")
# print(Throughput10[NRuns_scen11])

# print("PDR 200 4enb ultima pos LTE:")
# print(Throughput[NRuns_scen1])
# print("PDR 200 4enb ultima pos UOS:")
# print(Throughput1[NRuns_scen2])
# print("PDR 200 4enb ultima pos PERCEPT:")
# print(Throughput11[NRuns_scen12])

# # Array with means of scenarios
# means_2enb = [np.mean(Throughput6[NRuns_scen7]),np.mean(Throughput7[NRuns_scen8]),np.mean(Throughput8[NRuns_scen9]),
#               np.mean(Throughput2[NRuns_scen3]),np.mean(Throughput3[NRuns_scen4]),np.mean(Throughput10[NRuns_scen11])]

# means_4enb = [np.mean(Throughput4[NRuns_scen5]),np.mean(Throughput5[NRuns_scen6]),np.mean(Throughput9[NRuns_scen10]), 
#               np.mean(Throughput[NRuns_scen1]),np.mean(Throughput1[NRuns_scen2]),np.mean(Throughput11[NRuns_scen12])]
...
plt.savefig("Graph_Avg_PDR_Percept_15UABS.pdf", format='pdf', dpi=1000, bbox_inches = "tight")
#plt.show()
