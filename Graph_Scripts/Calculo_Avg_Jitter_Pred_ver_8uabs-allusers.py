...
#smallcells 400 Users
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/LTE/4enB_400U/plot_Jitter_400_4_0') as MeanThroughput:

    data1 = np.array(list((int(Run),int(time), float(Throughput)) for Run, time, Throughput in csv.reader(MeanThroughput, delimiter= ' ')))
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/UOS/4enB_8UABS_400U/plot_Jitter_400_4_8') as MeanThroughputUABS:
...
#PERCEPT 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/Percept/4enB_8UABS_400U/plot_Jitter_400_4_8') as MeanThroughputUABS7:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/UOS/4enB_15UABS_400U/plot_Jitter_400_4_15') as MeanThroughputUABS8:
...
#PERCEPT 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/Percept/4enB_15UABS_400U/plot_Jitter_400_4_15') as MeanThroughputUABS9:
...
#UOS 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/UOS/4enB_4UABS_400U/plot_Jitter_400_4_4') as MeanThroughputUABS16:
...
#PERCEPT 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/Percept/4enB_4UABS_400U/plot_Jitter_400_4_4') as MeanThroughputUABS17:
...
#smallcells 200 Users
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/LTE/4enB_200U/plot_Jitter_200_4_0') as MeanThroughput1:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_8UABS_200U/plot_Jitter_200_4_8') as MeanThroughputUABS1:
...
#PERCEPT 8UABS 
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_8UABS_200U/plot_Jitter_200_4_8') as MeanThroughputUABS6:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_15UABS_200U/plot_Jitter_200_4_15') as MeanThroughputUABS10:
...
#PERCEPT 15UABS 
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_15UABS_200U/plot_Jitter_200_4_15') as MeanThroughputUABS11:
...
#UOS 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_4UABS_200U/plot_Jitter_200_4_4') as MeanThroughputUABS18:
...
#PERCEPT 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_4UABS_200U/plot_Jitter_200_4_4') as MeanThroughputUABS19:
...
#smallcells 300 Users
#LTE
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/LTE/4enB_300U/plot_Jitter_300_4_0') as MeanThroughput2:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/UOS/4enB_8UABS_300U/plot_Jitter_300_4_8') as MeanThroughputUABS2:
...
#PERCEPT 8UABS    
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/Percept/4enB_8UABS_300U/plot_Jitter_300_4_8') as MeanThroughputUABS5:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/UOS/4enB_15UABS_300U/plot_Jitter_300_4_15') as MeanThroughputUABS12:
...
#PERCEPT 15UABS    
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/Percept/4enB_15UABS_300U/plot_Jitter_300_4_15') as MeanThroughputUABS13:
...
#UOS 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/LTE_and_UOS/UOS/4enB_4UABS_300U/plot_Jitter_300_4_4') as MeanThroughputUABS20:
...
#PERCEPT 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/results_300_and_400/Small_Cells/Percept/4enB_4UABS_300U/plot_Jitter_300_4_4') as MeanThroughputUABS21:
...
#smallcells 100 Users
#LTE 
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/LTE/4enB_100U/plot_Jitter_100_4_0') as MeanThroughput3:
...
#UOS 8UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_8UABS_100U/plot_Jitter_100_4_8') as MeanThroughputUABS3:
...
#PERCEPT 8UABS      
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_8UABS_100U/plot_Jitter_100_4_8') as MeanThroughputUABS4:
...
#UOS 15UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_15UABS_100U/plot_Jitter_100_4_15') as MeanThroughputUABS14:
...
#PERCEPT 15UABS      
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_15UABS_100U/plot_Jitter_100_4_15') as MeanThroughputUABS15:
...
#UOS 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/LTE_and_UOS/UOS/4enB_4UABS_100U/plot_Jitter_100_4_4') as MeanThroughputUABS22:
...
#PERCEPT 4UABS
with open(path+'/home/emanuel/Desktop/IEEE_Article/Sera_el_final_o_no/Small_Cells/Percept/4enB_4UABS_100U/plot_Jitter_100_4_4') as MeanThroughputUABS23:
...
#---------------------100 - 300 Users SMALL CELLS - 8 UAV-BS------------------------------
#8 UAV-BS 100 Users SMALL CELLS
ax2.bar(np.arange(1),means_LTE_100, yerr=yerr_LTE_100 ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
ax2.bar(np.arange(1)+0.6,means_UOS_100_8, yerr=yerr_UOS_100_8 ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
ax2.bar(np.arange(1)+1.2,means_Percept_100_8, yerr=yerr_Percept_100_8 ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
#8 UAV-BS 200 Users SMALL CELLS
ax2.bar(np.arange(1)+3,means_LTE_200, yerr=yerr_LTE_200 ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
ax2.bar(np.arange(1)+3.6,means_UOS_200_8, yerr=yerr_UOS_200_8 ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
ax2.bar(np.arange(1)+4.2,means_Percept_200_8, yerr=yerr_Percept_200_8 ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
#8 UAV-BS 300 Users SMALL CELLS
ax2.bar(np.arange(1)+6,means_LTE_100_SC, yerr=yerr_LTE_100_SC ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
ax2.bar(np.arange(1)+6.6,means_UOS_100_8_SC, yerr=yerr_UOS_100_8_SC ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
ax2.bar(np.arange(1)+7.2,means_Percept_100_8_SC, yerr=yerr_Percept_100_8_SC ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
#8 UAV-BS 400 Users SMALL CELLS
# ax2.bar(np.arange(1)+9,means_LTE_200_SC, yerr=yerr_LTE_200_SC ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
# ax2.bar(np.arange(1)+9.6,means_UOS_200_8_SC, yerr=yerr_UOS_200_8_SC ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
# ax2.bar(np.arange(1)+10.2,means_Percept_200_8_SC, yerr=yerr_Percept_200_8_SC ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
...
#---------------------100 - 400 Users SMALL CELLS - 8 UAV-BS------------------------------
#8 UAV-BS 100 Users SMALL CELLS
ax3.bar(np.arange(1),means_LTE_100, yerr=yerr_LTE_100 ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
ax3.bar(np.arange(1)+0.6,means_UOS_100_8, yerr=yerr_UOS_100_8 ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
ax3.bar(np.arange(1)+1.2,means_Percept_100_8, yerr=yerr_Percept_100_8 ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
#8 UAV-BS 200 Users SMALL CELLS
...
#8 UAV-BS 300 Users SMALL CELLS
ax3.bar(np.arange(1)+6,means_LTE_100_SC, yerr=yerr_LTE_100_SC ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
ax3.bar(np.arange(1)+6.6,means_UOS_100_8_SC, yerr=yerr_UOS_100_8_SC ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
ax3.bar(np.arange(1)+7.2,means_Percept_100_8_SC, yerr=yerr_Percept_100_8_SC ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
#8 UAV-BS 400 Users SMALL CELLS
ax3.bar(np.arange(1)+9,means_LTE_200_SC, yerr=yerr_LTE_200_SC ,width =0.6, color= uniquefuckingcolors[0], align="center", error_kw=dict(lw=2, capsize=5, capthick=2))
ax3.bar(np.arange(1)+9.6,means_UOS_200_8_SC, yerr=yerr_UOS_200_8_SC ,width =0.6, color= uniquefuckingcolors[1], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
ax3.bar(np.arange(1)+10.2,means_Percept_200_8_SC, yerr=yerr_Percept_200_8_SC ,width =0.6, color= uniquefuckingcolors[2], align="center",error_kw=dict(lw=2, capsize=5, capthick=2))
...
plt.savefig("Graph_Avg_Jitter_PERCEPT_AllUsers_8UAV.pdf", format='pdf', dpi=1000, bbox_inches = "tight")
#plt.show()
...
fig2.savefig('Jitter_S_8UAVBS-100U-300U.eps', bbox_inches=extent)#.expanded(1.15, 1.15))
...
fig2.savefig('Jitter_S_8UAVBS-100U-400U.eps',  bbox_inches=extent)#.expanded(1.15, 1.15))

# extent = ax4.get_tightbbox(fig2.canvas.renderer).transformed(fig2.dpi_scale_trans.inverted())
# fig2.savefig('Jitter_300U_S.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))

# extent = ax5.get_tightbbox(fig2.canvas.renderer).transformed(fig2.dpi_scale_trans.inverted())
# fig2.savefig('Jitter_400U_S.pdf',  bbox_inches=extent)#.expanded(1.15, 1.15))
